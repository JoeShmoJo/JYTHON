...
#### This section gets data from the Forecast DSS file.
		...
		###GPR BELOW
		GPRLBElev = cwmsFile.get("//GPR/Elev-Forebay/30Sep2024 - 28Jan2025/1Hour/CBT-REV/")
		...
		#### FOS BELOW
		FOSLBElev = cwmsFile.get("//FOS/Elev-Forebay/30Sep2024 - 28Jan2025/1Hour/CBT-REV/")
		...
		####DET Below
		DETLBElev = cwmsFile.get("//DET/Elev-Forebay/30Sep2024 - 28Jan2025/1Hour/CBT-REV/")
		...
		FRNLBElev = cwmsFile.get("//FRN/Elev-Forebay/30Sep2024 - 28Jan2025/6Hour/RFC-FCST/")
