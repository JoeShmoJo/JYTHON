...
#### This section gets data from the Forecast DSS file.
		...
		RFCVID = cwmsFile.get("//VIDO/FLOW--INST/01MAR2019/IR-MONTH/RFC-FCST/")
		SimVIDflow = cwmsFile.get("//MCKENZIE_AT VIDA/FLOW-IN/01JUL2019/3HOUR/------R0/")
		RFCVIDflow = cwmsFile.get("/MCKENZIE RIVER/VIDA OR/FLOW/01MAR2019/1HOUR/USGS 14162500/")
...
###### Save Plot as A jpeg####
		...
		VID_Plot.saveToJpeg("C:\CWMS\Plots\EUG\VID_FcstPlot.jpg")
		#VID_Plot.close()
		
		GOS_Plot.setSize(1400, 1300)
		GOS_Plot.setLocation(100, 100)
		GOS_Plot.saveToJpeg("C:\CWMS\Plots\EUG\GOS_FcstPlot.jpg")
		#GOS_Plot.close()
		
		JAS_Plot.setSize(1400, 1300)
		JAS_Plot.setLocation(100, 100)
		JAS_Plot.saveToJpeg("C:\CWMS\Plots\EUG\JAS_FcstPlot.jpg")
		#JAS_Plot.close()
		
		EUG_Plot.setSize(1400, 1300)
		EUG_Plot.setLocation(100, 100)
		EUG_Plot.saveToJpeg("C:\CWMS\Plots\EUG\EUG_FcstPlot.jpg")
		#EUG_Plot.close()
