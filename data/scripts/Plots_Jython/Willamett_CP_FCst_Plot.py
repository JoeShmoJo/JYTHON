...
#### This section gets data from the Forecast DSS file.
		...
		RFCJeff = cwmsFile.get("//JFFO/FLOW-LOCAL--INST/01MAR2019/IR-MONTH/BLEND-RFC-OBS-RFC-FCST/")
...
###### Save Plot as A jpeg####
		...
		MEHO_Plot.saveToJpeg("C:\CWMS\Plots\CP\MEHO_FcstPlot.jpg")
		#MEHO_Plot.close()
		
		WTL_Plot.setSize(1400, 1300)
		WTL_Plot.setLocation(100, 100)
		WTL_Plot.saveToJpeg("C:\CWMS\Plots\CP\WTL_FcstPlot.jpg")
		#WTL_Plot.close()
		
		JEF_Plot.setSize(1400, 1300)
		JEF_Plot.setLocation(100, 100)
		JEF_Plot.saveToJpeg("C:\CWMS\Plots\CP\JEF_FcstPlot.jpg")
		#JEF_Plot.close()
