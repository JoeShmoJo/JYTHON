...
#### This section gets data from the Forecast DSS file.
		###HCR Below
		HCRLBElev = cwmsFile.get("//HCR/Elev-Forebay/30Sep2024 - 28Jan2025/1Hour/CBT-REV/")
		...
		SimLOPOutflow.setVersion("50% Flow Forecast")
		LOPRuleCurve = cwmsFile.read("//LOOKOUT POINT-CONSERVATION/ELEV-ZONE//1DAY/------20/")
		LOPRuleCurve.setVersion("25% Flow Forecast")
		LOPLBElev = cwmsFile.get("//LOP/Elev-Forebay/30Sep2024 - 28Jan2025/1Hour/CBT-REV/")
		...
		CGRLBElev = cwmsFile.get("//CGR/Elev-Forebay/30Sep2024 - 28Jan2025/1Hour/CBT-REV/")
		...
		###FAL Below
		FALLBElev = cwmsFile.get("//FAL/Elev-Forebay/30Sep2024 - 28Jan2025/6Hour/RFC-FCST/")
		...
		BLRLBElev = cwmsFile.get("//BLU/Elev-Forebay/30Sep2024 - 28Jan2025/6Hour/RFC-FCST/")
		...
		DORLBElev = cwmsFile.get("//DOR/Elev-Forebay/30Sep2024 - 28Jan2025/6Hour/RFC-FCST/")
		...
		COTLBElev = cwmsFile.get("//COT/Elev-Forebay/30Sep2024 - 28Jan2025/6Hour/RFC-FCST/")
...
#####Axis Formating####
		...
		FALFHL.axis = "Y"
		FALFHL.value = "728"
		FALFHL.labelText = "FAL LWR Fish Horn ~ 728"
		FALFHL.labelPosition = "below"
		FALFHL.labelColor = "black"
		FALFHL.labelFont = "Dialog,BOLD,14";
		FALFHL.lineColor = "black"
		FALFHL.lineStyle = "dot"
		FALFHL.lineWidth = 4
		TopViewport_FAL.addAxisMarker(FALFHL)  
		        
		FALFHM = AxisMarker()
		FALFHM.axis = "Y"
		FALFHM.value = "765"
		FALFHM.labelText = "FAL MID Fish Horn ~ 765"
		FALFHM.labelPosition = "above"
		FALFHM.labelColor = "black"
		FALFHM.labelFont = "Dialog,BOLD,14";
		FALFHM.lineColor = "black"
		FALFHM.lineStyle = "dot"
		FALFHM.lineWidth = 4
		TopViewport_FAL.addAxisMarker(FALFHM)  
		
		FALFHU = AxisMarker()
		FALFHU.axis = "Y"
		FALFHU.value = "800"
		FALFHU.labelText = "FAL UPP Fish Horn ~ 800"
		FALFHU.labelPosition = "below"
		FALFHU.labelColor = "black"
		FALFHU.labelFont = "Dialog,BOLD,14";
		FALFHU.lineColor = "black"
		FALFHU.lineStyle = "dot"
		FALFHU.lineWidth = 4
		TopViewport_FAL.addAxisMarker(FALFHU)
...
############ Set Data up for exporting to Excel####
		...
		ExcelTable.createExcelFile(datasets,"Z:\McKenzieAndBelowFcst.xls")
