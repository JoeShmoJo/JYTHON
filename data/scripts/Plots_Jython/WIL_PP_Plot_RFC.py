...
#### This section gets data from the Forecast DSS file.
		...
		SimDETElev = cwmsFile.get("//DETROIT-POOL/ELEV//3HOUR/------R0/")
		SimDETInflow = cwmsFile.get("//DETROIT-POOL/FLOW-IN/01AUG2019/3HOUR/------R0/")
		...
		SimDETOutflow = cwmsFile.get("//DETROIT-POOL/FLOW-OUT//3HOUR/------R0/")
	
		
		OBSGPRElev = cwmsFile.get("/WILLAMETTE/GREEN PETER/ELEVATION/01DEC2018/1HOUR/OBSERVED/")
		SimGPRElev = cwmsFile.get("//GREEN PETER-POOL/ELEV/01DEC2018/3HOUR/------R0/")
		SimGPRInflow = cwmsFile.get("//GREEN PETER-POOL/FLOW-IN/01DEC2018/3HOUR/------R0/")
		SimGPROutflow = cwmsFile.get("//GREEN PETER-POOL/FLOW-OUT/01DEC2018/3HOUR/------R0/")
		...
		SimLOPElev = cwmsFile.get("//LOOKOUT POINT-POOL/ELEV//3HOUR/------R0/")
		SimLOPInflow = cwmsFile.get("//LOOKOUT POINT-POOL/FLOW-IN//3HOUR/------R0/")
		...
		SimLOPOutflow = cwmsFile.get("//LOOKOUT POINT-POOL/FLOW-OUT//3HOUR/------R0/")
...
### Create Plot ####
		...
		#BottomView.addCurve("Y1", OBSDETInflow)
		...
		#BottomView.addCurve("Y1", OBSGPRInflow)
		...
		#BottomView.addCurve("Y1", OBSLOPInflow)
